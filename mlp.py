...
class Convolution:
    ...
    def generate_shape(self):
        ...
        self.kernel = np.random.normal(0, 1, (r_width, kernel_num)) * 0.01
...
class MLP:
    def __init__(self, batch_size, learning_rate):
        ...
        self.fc1 = InnerProduct(20*12*12, batch_size, 100)
...
#conv2 = Convolution((batch_size, 12, 12, 20), (5, 5, 20))
#relu2 = ReLU([batch_size, 8, 8, 20])
#pool2 = Pooling([batch_size, 8, 8, 20], (2, 2), stride=2)
